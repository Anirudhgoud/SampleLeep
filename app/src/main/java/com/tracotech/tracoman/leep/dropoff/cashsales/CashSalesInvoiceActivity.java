...
import com.tracotech.tracoman.viewmodels.dropoff.cashsales.CashSalesInvoiceViewModel;
...
public class CashSalesInvoiceActivity extends ParentAppCompatActivity {
    ...
    private View productListItemView(Product product) {
        ...
        if (product.getQuantity() > 0){
            ...
            tvAmount.setText(StringUtils.amountToDisplay((float) product.getTotalPrice(), this));
        ...
        if (product.getReturnQuantity() > 0){
            ...
            tvReturnedAmount.setText(StringUtils.amountToDisplay((float) product.getTotalReturnsPrice(), this));
            llReturnedLabel.setVisibility(View.VISIBLE);
