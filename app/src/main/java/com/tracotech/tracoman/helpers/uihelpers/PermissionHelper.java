...
public class PermissionHelper {
    ...
    public void request(PermissionCallback permissionCallback) {
        ...
        if (!checkSelfPermission(permissions)) {
            ...
            LogUtils.info(TAG, "PERMISSION: Permission Granted");
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (denied) {
                ...
                if (!showRational && !currentShowRational) {
                    LogUtils.info(TAG, "PERMISSION: Permission Denied By System");
                    if (mPermissionCallback != null)
                        mPermissionCallback.onPermissionDeniedBySystem();
                } else {
                    LogUtils.info(TAG, "PERMISSION: Permission Denied");
    ...
    public interface PermissionCallback {
        ...
        default void onIndividualPermissionGranted(String grantedPermission[]){
            onPermissionDenied();
        }

        void onPermissionDenied();

        default void onPermissionDeniedBySystem(){
            onPermissionDenied();
        }
    }
