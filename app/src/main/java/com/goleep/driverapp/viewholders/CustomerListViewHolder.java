...
public class CustomerListViewHolder extends RecyclerView.ViewHolder{
    ...
    private void setItemListeners(Customer customer){
        itemView.setOnClickListener(v -> customerClickEventListener.onCustomerSelectTap(customer.getId()));
        btSelect.setOnClickListener(v -> customerClickEventListener.onCustomerSelectTap(customer.getId()));
    }
